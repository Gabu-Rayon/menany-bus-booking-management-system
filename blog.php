				...
				<div class="blog_post_container">
					...
					<div class="blog_post">
						<div class="blog_post_image">
							<img src="images/08.jpg" alt="https://unsplash.com/@anniespratt">
							<div class="blog_post_date d-flex flex-column align-items-center justify-content-center">
								<div class="blog_post_day">01</div>
								<div class="blog_post_month">April, 2023</div>
							</div>
						</div>
					...
					<div class="blog_post">
						<div class="blog_post_image">
							<img src="images/08.jpg" alt="https://unsplash.com/@tschax">
							<div class="blog_post_date d-flex flex-column align-items-center justify-content-center">
								<div class="blog_post_day">01</div>
								<div class="blog_post_month">April, 2023</div>
							</div>
					...
					<div class="blog_post">
						<div class="blog_post_image">
							<img src="images/08.jpg" alt="https://unsplash.com/@stilclassics">
							<div class="blog_post_date d-flex flex-column align-items-center justify-content-center">
								<div class="blog_post_day">01</div>
								<div class="blog_post_month">April, 2023</div>
							</div>
					...
					<div class="latest_posts_container">
						<ul>
							...
							<li class="latest_post clearfix">
								...
								<div class="latest_post_content">
									...
									<div class="latest_post_meta">
										...
										<div class="latest_post_date trans_200"><a href="#">Aug 25, 2016</a>
										</div>
									</div>
								</div>
							</li>
							...
							<li class="latest_post clearfix">
								...
								<div class="latest_post_content">
									<div class="latest_post_title trans_200"><a href="#">Tips to travel
											light</a></div>
									<div class="latest_post_meta">
										<div class="latest_post_author trans_200"><a href="#">by Jane Smith</a>
										</div>
							...
							<li class="latest_post clearfix">
								...
								<div class="latest_post_content">
									<div class="latest_post_title trans_200"><a href="#">How to book your
											ticket</a></div>
									<div class="latest_post_meta">
										<div class="latest_post_author trans_200"><a href="#">by Jane Smith</a>
										</div>
						...
						<ul class="gallery_items d-flex flex-row align-items-start justify-content-between flex-wrap">
							...
							<li class="gallery_item">
								<a class="colorbox"
									...
									<img src="images/gallery_1.jpg" alt="https://unsplash.com/@kensuarez">
								</a>
							</li>
							<li class="gallery_item">
								<a class="colorbox"
									...
									<img src="images/gallery_1.jpg" alt="https://unsplash.com/@jakobowens1">
								</a>
							</li>
							<li class="gallery_item">
								<a class="colorbox"
									...
									<img src="images/gallery_1.jpg" alt="https://unsplash.com/@seefromthesky">
								</a>
							</li>
							<li class="gallery_item">
								<a class="colorbox"
									...
									<img src="images/gallery_1.jpg" alt="https://unsplash.com/@deannaritchie">
								</a>
							</li>
							<li class="gallery_item">
								<a class="colorbox"
									...
									<img src="images/gallery_1.jpg" alt="https://unsplash.com/@benobro">
								</a>
							</li>
						</ul>
					</div>
