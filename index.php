	...
	<div class="home_slider_container">
		...
		<div class="owl-carousel owl-theme home_slider">
			...
			<div class="owl-item home_slider_item">
				...
				<div class="home_slider_background" style="background-image:url(images/15.jpg)"></div>
			...
			<!-- Slider Item -->
			<div class="owl-item home_slider_item">
				<div class="home_slider_background" style="background-image:url(images/18.jpg)"></div>
			...
			<!-- Slider Item -->
			<div class="owl-item home_slider_item">
				<div class="home_slider_background" style="background-image:url(images/17.jpg)"></div>
...
<div class="intro">
	<div class="container">
		<div class="row">
			<div class="col">
				<h2 class="intro_title text-center">We are the best Luxury travel Agency</h2>
			</div>
		</div>
		<div class="row">
			<div class="col-lg-10 offset-lg-1">
				<div class="intro_text text-center">
					<p> Whether you're planning a family trip, group
						outing, or solo adventure, our buses are equipped with modern amenities to enhance your travel
						experience. Trust our reputable bus services for seamless travel, exceptional customer service,
						and a
						commitment to your satisfaction. Book your next journey with us and enjoy hassle-free travel
						from start
						to finish. </p>
				</div>
			</div>
		...
		<div class="row intro_items">
			...
			<div class="col-lg-4 intro_col">
				<div class="intro_item">
					...
					<div class="intro_item_background" style="background-image:url(images/17.jpg)">
					</div>
					<div class="intro_item_content d-flex flex-column align-items-center justify-content-center">
						<div class="intro_date">Offer on Ticket</div>
						<div class="button intro_button">
							<div class="button_bcg"></div><a href="#">see
								more<span></span><span></span><span></span></a>
						</div>
						<div class="intro_center text-center">
							<h2>Nairobi-<i>to</i>-Maua</h2>
							<div class="intro_price">From Ksh1500</div>
			...
			<div class="col-lg-4 intro_col">
				<div class="intro_item">
					...
					<div class="intro_item_background" style="background-image:url(images/15.jpg)">
					</div>
					<div class="intro_item_content d-flex flex-column align-items-center justify-content-center">
						<div class="intro_date">Offer on ticket</div>
						<div class="button intro_button">
						...
						<div class="intro_center text-center">
							<h2>Meru -<i>to</i>-Nairobi</h2>
							<div class="intro_price">From Ksh700</div>
							<div class="rating rating_4">
								<i class="fa fa-star"></i>
								<i class="fa fa-star"></i>
								<i class="fa fa-star"></i>
			...
			<div class="col-lg-4 intro_col">
				<div class="intro_item">
					...
					<div class="intro_item_background" style="background-image:url(images/18.jpg)">
					</div>
					<div class="intro_item_content d-flex flex-column align-items-center justify-content-center">
						<div class="intro_date">Offer on ticket</div>
						<div class="button intro_button">
	...
	<div class="cta">
		...
		<div class="cta_background" style="background-image:url(images/19.jpg)"></div>
		...
		<div class="container">
			<div class="row">
				<div class="col text-center">
					<h2 class="section_title">the best offers in travelling</h2>
				</div>
			</div>
						...
						<div class="row">
							<div class="col-lg-6">
								<div class="offers_image_container">
									...
									<div class="offers_image_background" style="background-image:url(images/17.jpg)"></div>
						...
						<div class="row">
							<div class="col-lg-6">
								<div class="offers_image_container">
									...
									<div class="offers_image_background" style="background-image:url(images/18.jpg)"></div>
						...
						<div class="row">
							<div class="col-lg-6">
								<div class="offers_image_container">
									...
									<div class="offers_image_background" style="background-image:url(images/19.jpg)"></div>
				...
				<div class="col">
					...
					<div class="test_slider_container">
						<div class="owl-carousel owl-theme test_slider">
							...
							<div class="owl-item">
								<div class="test_item">
									<div class="test_image"><img src="images/review_2.jpg" alt="https://unsplash.com/@anniegray"></div>
							...
							<div class="owl-item">
								<div class="test_item">
									<div class="test_image"><img src="images/review_2.jpg" alt="https://unsplash.com/@tschax"></div>
									<div class="test_icon"><img src="images/backpack.png" alt=""></div>
									<div class="test_content_container">
										<div class="test_content">
											<div class="test_item_info">
							...
							<div class="owl-item">
								<div class="test_item">
									<div class="test_image"><img src="images/review_2.jpg" alt="https://unsplash.com/@seefromthesky"></div>
									<div class="test_icon"><img src="images/backpack.png" alt=""></div>
									<div class="test_content_container">
										<div class="test_content">
											<div class="test_item_info">
							...
							<div class="owl-item">
								<div class="test_item">
									<div class="test_image"><img src="images/review_2.jpg" alt=""></div>
									<div class="test_icon"><img src="images/backpack.png" alt=""></div>
									<div class="test_content_container">
										<div class="test_content">
											<div class="test_item_info">
	...
	<div class="trending">
		<div class="container">
			<div class="row">
				<div class="col text-center">
					<h2 class="section_title">trending tickets now</h2>
				</div>
			</div>
			<div class="row trending_container">
				...
				<div class="col-lg-3 col-sm-6">
					<div class="trending_item clearfix">
						<div class="trending_image"><img src="images/17.jpg" alt="https://unsplash.com/@fransaraco"></div>
				...
				<div class="col-lg-3 col-sm-6">
					<div class="trending_item clearfix">
						<div class="trending_image"><img src="images/03.jpg" alt="https://unsplash.com/@grovemade"></div>
						<div class="trending_content">
				...
				<div class="col-lg-3 col-sm-6">
					<div class="trending_item clearfix">
						<div class="trending_image"><img src="images/18.jpg" alt="https://unsplash.com/@jbriscoe"></div>
						<div class="trending_content">
				...
				<div class="col-lg-3 col-sm-6">
					<div class="trending_item clearfix">
						<div class="trending_image"><img src="images/02.jpg" alt="https://unsplash.com/@oowgnuj"></div>
						<div class="trending_content">
							<div class="trending_title"><a href="#">mars hotel</a></div>
							<div class="trending_price">From $182</div>
							<div class="trending_location">madrid, spain</div>
				...
				<div class="col-lg-3 col-sm-6">
					<div class="trending_item clearfix">
						<div class="trending_image"><img src="images/03.jpg" alt="https://unsplash.com/@mindaugas"></div>
						<div class="trending_content">
							<div class="trending_title"><a href="#">grand hotel</a></div>
							<div class="trending_price">From $182</div>
							<div class="trending_location">madrid, spain</div>
				...
				<div class="col-lg-3 col-sm-6">
					<div class="trending_item clearfix">
						<div class="trending_image"><img src="images/17.jpg" alt="https://unsplash.com/@itsnwa"></div>
						<div class="trending_content">
							<div class="trending_title"><a href="#">mars hotel</a></div>
							<div class="trending_price">From $182</div>
							<div class="trending_location">madrid, spain</div>
				...
				<div class="col-lg-3 col-sm-6">
					<div class="trending_item clearfix">
						<div class="trending_image"><img src="images/trend_6.png" alt="https://unsplash.com/@rktkn"></div>
						<div class="trending_content">
							<div class="trending_title"><a href="#">queen hotel</a></div>
							<div class="trending_price">From $182</div>
							<div class="trending_location">madrid, spain</div>
				...
				<div class="col-lg-3 col-sm-6">
					<div class="trending_item clearfix">
						<div class="trending_image"><img src="images/trend_6.png" alt="https://unsplash.com/@thoughtcatalog"></div>
						<div class="trending_content">
							<div class="trending_title"><a href="#">mars hotel</a></div>
							<div class="trending_price">From $182</div>
							<div class="trending_location">madrid, spain</div>
			...
			<div class="col-lg-3 footer_column">
				<div class="footer_col">
					<div class="footer_content footer_about">
						...
						<p class="footer_about_text">Experience reliable and convenient bus services for your travel
							needs. Our professional team provides
							efficient transportation solutions, ensuring a comfortable and safe journey. Discover
							affordable fares,
