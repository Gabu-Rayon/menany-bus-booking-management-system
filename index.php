    ...
    <div class="home_slider_container">
        ...
        <div class="owl-carousel owl-theme home_slider">
            ...
            <div class="owl-item home_slider_item">
                ...
                <div class="home_slider_background" style="background-image:url(images/trial-test.jpeg)"></div>
            ...
            <!-- Slider Item -->
            <div class="owl-item home_slider_item">
                <div class="home_slider_background" style="background-image:url(images/Meru-town.jpeg)"></div>
            ...
            <!-- Slider Item -->
            <div class="owl-item home_slider_item">
                <div class="home_slider_background" style="background-image:url(images/Maua-town.jpeg)"></div>
        ...
        <div class="row intro_items">
            ...
            <div class="col-lg-4 intro_col">
                <div class="intro_item">
                    ...
                    <div class="intro_item_background" style="background-image:url(images/trial-test.jpeg)">
                    </div>
            ...
            <div class="col-lg-4 intro_col">
                <div class="intro_item">
                    ...
                    <div class="intro_item_background" style="background-image:url(images/Meru-town.jpeg)">
                    </div>
                    <div class="intro_item_content d-flex flex-column align-items-center justify-content-center">
                        <div class="intro_date">Offer on ticket</div>
                        <div class="button intro_button">
            ...
            <div class="col-lg-4 intro_col">
                <div class="intro_item">
                    ...
                    <div class="intro_item_background" style="background-image:url(images/Maua-town.jpeg)">
                    </div>
                    <div class="intro_item_content d-flex flex-column align-items-center justify-content-center">
                        <div class="intro_date">Offer on ticket</div>
                        <div class="button intro_button">
...
<div class="cta">
    ...
    <div class="cta_background" style="background-image:url(images/nairobi-02.jpeg)"></div>
                ...
                <div class="cta_slider_container">
                    <div class="owl-carousel owl-theme cta_slider">
                        ...
                        <div class="owl-item cta_item text-center">
                            <div class="cta_title">Express deluxe package</div>
                        ...
                        <!-- CTA Slider Item -->
                        <div class="owl-item cta_item text-center">
                            <div class="cta_title">Express deluxe package II</div>
                            <div class="rating_r rating_r_4">
                                <i></i>
                                <i></i>
                                <i></i>
                        ...
                        <!-- CTA Slider Item -->
                        <div class="owl-item cta_item text-center">
                            <div class="cta_title">Express deluxe package III</div>
                            <div class="rating_r rating_r_4">
                                <i></i>
                                <i></i>
                                <i></i>
    ...
    <div class="container">
        <div class="row">
            <div class="col text-center">
                <h2 class="section_title">the besT tickets offers with 50% Discount</h2>
            </div>
        </div>
                        ...
                        <div class="col-lg-6">
                            <div class="offers_image_container">
                                ...
                                <div class="offers_image_background"
                                    style="background-image:url(images/nairobi-04.jpeg)"></div>
                                <div class="offer_name"><a href="#">Nairobi to Meru</a></div>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="offers_content">
                                <div class="offers_price">Ksh700<span>per ticket</span></div>
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="offers_image_container">
                                ...
                                <div class="offers_image_background"
                                    style="background-image:url(images/Meru-town.jpeg)"></div>
                                <div class="offer_name"><a href="#">Meru to Nairobi</a></div>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="offers_content">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="offers_image_container">
                                ...
                                <div class="offers_image_background"
                                    style="background-image:url(images/Maua-town.jpeg)"></div>
                                <div class="offer_name"><a href="#">Nairobi to Maua</a></div>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="offers_content">
                                <div class="offers_price">Ksh1300<span>per ticket</span></div>
                                <div class="rating_r rating_r_4 offers_rating">
                                    <i></i>
                                    <i></i>
                                    <i></i>
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="offers_image_container">
                                ...
                                <div class="offer_name"><a href="#">Nairobi to Nanyuki</a></div>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="offers_content">
                                <div class="offers_price">Ksh1500<span>per ticket</span></div>
                                <div class="rating_r rating_r_4 offers_rating">
                                    <i></i>
                                    <i></i>
                                    <i></i>
