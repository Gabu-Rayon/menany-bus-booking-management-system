    ...
    <div class="super_container">
                    ...
                    <div class="row">
                        <div class="col d-flex flex-row">
                            ...
                            <div class="user_box ml-auto">
                                ...
                                <div class="user_box_register user_box_link"><a href="sign-in.php">Sign Up</a></div>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="intro">
            <div class="container">
                <div class="row">
                    <div class="col-lg-7">
                        <div class="intro_image"><img src="images/bus01.jpg" height="560" width="700" alt=""></div>
                    </div>
                    <div class="col-lg-5">
                ...
                <div class="row">
                    <div class="col">
                        <div class="stats_years">
                            <div class="stats_years_last">2015</div>
                            <div class="stats_years_new float-right">2023</div>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col">
                        <div class="stats_contents">
                            ...
                            <div class="stats_item d-flex flex-md-row flex-column clearfix">
                                ...
                                <div class="stats_bar order-md-2 order-2" data-x="1642" data-y="3527"
                                    data-color="#31124b">
                            ...
                            <div class="stats_item d-flex flex-md-row flex-column clearfix">
                                ...
                                <div class="stats_bar order-md-2 order-2" data-x="768" data-y="145"
                                    data-color="#a95ce4">
                                    <div class="stats_bar_perc">
                                        <div>
                                            <div class="stats_bar_value"></div>
                            ...
                            <div class="stats_item d-flex flex-md-row flex-column clearfix">
                                ...
                                <div class="stats_bar order-md-2 order-2" data-x="11546" data-y="9321"
                                    data-color="#fa6f1b">
                                    <div class="stats_bar_perc">
                                        <div>
                                            <div class="stats_bar_value"></div>
                ...
                <div class="row">
                    <div class="col">
                        <div class="add_container">
                            <div class="add_background" style="background-image:url(images/Meru-town.jpeg)"></div>
